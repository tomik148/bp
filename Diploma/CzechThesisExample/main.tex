...
\section{Moje úkoly}
	...
	\subsection{\EFilters}
		...
		\subsubsection{WPF}
			...
			View jsou napsána v XAMLu což je značkovací jazyk založený na XML. Kde jednotlivé tagy jsou reprezentace tříd v {\Csharp} (např. "~<sys:Int32>~" kde "sys" je namespace "System", je třída "Int32" ). XAML umožňuje editaci za běhu programu, což bylo velmi užitečné při stylování. 
